var app = ( function() {
	...
	*/
	...
	function initModels() {
		...
		//Tanne8
		createModel("kegel", fs, cPineGreen, [0.8, 1.1, -1], [0, 0, 0], [0.12, 0.5, 0.12],mPineGreen);
		createModel("kegel", fs, cPineGreen, [0.8, 0.9, -1], [0, 0, 0], [0.16, 0.4, 0.16],mPineGreen);
		createModel("zylinder", fs, cDarkBrown, [0.8, 0.1, -1], [0, 0, 0], [.5, 2.2, .5],mDarkBrown);
